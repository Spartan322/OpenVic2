...
func _ready():
	...
	if ShaderManager.set_up_shader(map_material, true) != OK:
	...
	_map_shader_material.set_shader_parameter(ShaderManager.param_terrain_tile_factor,
...
func _on_province_selected(index : int) -> void:
	_map_shader_material.set_shader_parameter(ShaderManager.param_selected_index, index)
...
func _update_mouse_map_position() -> void:
	...
	if _mouse_over_viewport:
		_map_shader_material.set_shader_parameter(ShaderManager.param_hover_index, hover_index)
...
func _on_mouse_exited_viewport():
	...
	_map_shader_material.set_shader_parameter(ShaderManager.param_hover_index, 0)
